  ...
  static Future<void> initializeAchievements() async {
    try {
      ...
      final achievements = [
        ...
        {
          'id': 'words_200',
          'name': '200 mots appris',
          'description': 'Apprenez 200 mots',
          'icon': 'translate',
          'category': 'words',
          'requirements': {'type': 'words', 'value': 200, 'condition': '>='},
          'rewards': {'xp': 500, 'badge': 'words_200'},
          'tier': 'gold',
        },
        {
          'id': 'words_500',
          'name': '500 mots appris',
          'description': 'Apprenez 500 mots',
          'icon': 'translate',
          'category': 'words',
          'requirements': {'type': 'words', 'value': 500, 'condition': '>='},
          'rewards': {'xp': 1000, 'badge': 'words_500'},
          'tier': 'platinum',
        },
        {
          'id': 'level_15',
          ...
          'icon': 'emoji_events',
          'category': 'level',
          'requirements': {'type': 'level', 'value': 15, 'condition': '>='},
          'rewards': {'xp': 750, 'badge': 'level_15'},
          'tier': 'gold',
        },
        {
          'id': 'level_20',
          ...
          'icon': 'emoji_events',
          'category': 'level',
          'requirements': {'type': 'level', 'value': 20, 'condition': '>='},
          'rewards': {'xp': 1000, 'badge': 'level_20'},
          'tier': 'platinum',
        },
        {
          'id': 'fifteen_lessons',
          'name': '15 leçons',
          'description': 'Complétez 15 leçons',
          'icon': 'school',
          'category': 'learning',
          'requirements': {'type': 'lessons', 'value': 15, 'condition': '>='},
          'rewards': {'xp': 500, 'badge': 'fifteen_lessons'},
          'tier': 'gold',
        },
        {
          'id': 'twenty_lessons',
          ...
          'icon': 'school',
          'category': 'learning',
          'requirements': {'type': 'lessons', 'value': 20, 'condition': '>='},
          'rewards': {'xp': 750, 'badge': 'twenty_lessons'},
          'tier': 'gold',
        },
        {
          'id': 'fifty_lessons',
          ...
          'icon': 'school',
          'category': 'learning',
          'requirements': {'type': 'lessons', 'value': 50, 'condition': '>='},
          'rewards': {'xp': 2000, 'badge': 'fifty_lessons'},
          'tier': 'platinum',
        },
        {
          'id': 'xp_1000',
          ...
          'icon': 'stars',
          'category': 'xp',
          'requirements': {'type': 'xp', 'value': 1000, 'condition': '>='},
          'rewards': {'xp': 100, 'badge': 'xp_1000'},
          'tier': 'silver',
        },
        {
          'id': 'xp_5000',
          ...
          'icon': 'stars',
          'category': 'xp',
          'requirements': {'type': 'xp', 'value': 5000, 'condition': '>='},
          'rewards': {'xp': 500, 'badge': 'xp_5000'},
          'tier': 'gold',
        },
        {
          'id': 'xp_10000',
          'name': '10000 XP',
          'description': 'Accumulez 10000 XP',
          'icon': 'stars',
          'category': 'xp',
          'requirements': {'type': 'xp', 'value': 10000, 'condition': '>='},
          'rewards': {'xp': 1000, 'badge': 'xp_10000'},
          'tier': 'platinum',
        },
        {
          'id': 'best_streak_14',
          'name': 'Meilleur streak 14 jours',
          'description': 'Atteignez un meilleur streak de 14 jours',
          'icon': 'local_fire_department',
          'category': 'streak',
          'requirements': {
            'type': 'best_streak',
          ...
          'rewards': {'xp': 300, 'badge': 'best_streak_14'},
          'tier': 'silver',
        },
        {
          'id': 'best_streak_50',
          'name': 'Meilleur streak 50 jours',
          'description': 'Atteignez un meilleur streak de 50 jours',
          'icon': 'local_fire_department',
          'category': 'streak',
          'requirements': {
            'type': 'best_streak',
          ...
          'rewards': {'xp': 1000, 'badge': 'best_streak_50'},
          'tier': 'platinum',
        },
        {
          'id': 'study_time_5_hours',
          'name': '5 heures d\'étude',
          'description': 'Accumulez 5 heures de temps d\'étude',
          'icon': 'schedule',
          'category': 'study_time',
          'requirements': {
            'type': 'study_time',
          ...
          'rewards': {'xp': 500, 'badge': 'study_5h'},
          'tier': 'gold',
        },
        {
          'id': 'study_time_10_hours',
          'name': '10 heures d\'étude',
          'description': 'Accumulez 10 heures de temps d\'étude',
          'icon': 'schedule',
          'category': 'study_time',
          'requirements': {
            'type': 'study_time',
          ...
          'rewards': {'xp': 1000, 'badge': 'study_10h'},
          'tier': 'platinum',
        },
        {
          'id': 'exercises_100',
          ...
          'rewards': {'xp': 300, 'badge': 'exercises_100'},
          'tier': 'silver',
        },
        {
          'id': 'exercises_500',
          ...
          'rewards': {'xp': 1000, 'badge': 'exercises_500'},
          'tier': 'platinum',
        },
        {
          'id': 'accuracy_90_plus',
          'name': 'Précision 90%+',
          'description': 'Atteignez une précision de 90% ou plus',
          'icon': 'track_changes',
          'category': 'accuracy',
          'requirements': {'type': 'accuracy', 'value': 90, 'condition': '>='},
          'rewards': {'xp': 500, 'badge': 'accuracy_90'},
          'tier': 'gold',
        },
      ];
